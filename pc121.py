...
btn_max = Button(root, text = "Show Max Profitable Month", command = max_btn, bg = "red", fg = "white")
btn_max.place(relx = 0.5, rely = 0.4, anchor = CENTER)

btn_min = Button(root, text = "Show Min Profitable Month", command = min_btn, bg = "blue", fg = "black")
